    ...
    return (
        <>
            ...
            <div className="paragraphs">
                ...
                <p>JMc or JavaScript-like Minecraft function is a custom lauage design for minecraft datapack which is <span className="fst-italic">inspired</span> by JavaScript. It needs a compiler to compile it down to minecraft datapack.</p>
                <h2>Why use JMC?</h2>
