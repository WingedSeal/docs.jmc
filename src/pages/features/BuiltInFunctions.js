...
tellraw @a $result.toString();`} language='javascript' />
                ...
                <section id="hardcode_repeat" />
                <details className='feature'>
                    <summary>Hardcode.repeat()</summary>
...
tellraw @a "Hello World: 5"`} language='json' />
                ...
                <section id="hardcode_calc" />
                <details className='feature'>
                    <summary>Hardcode.calc()</summary>
...
tellraw @a "5^2=25"`} language='elixir' />
                ...
                <section id="player_first_join" />
                <details className='feature'>
                    <summary>Player.firstJoin()</summary>
...
...`} language='elixir' />
                ...
                <section id="player_rejoin" />
                <details className='feature'>
                    <summary>Player.rejoin()</summary>
